...
def main():
	...
	erun=euorun.euorun(cfg.np, cfg.system, cfg.N, cfg.M, cfg.ni, cfg.ncr, cfg.dW, cfg.output, cfg.input, cfg.initial_input, cfg.additional_parameter, cfg.log, cfg.verbose)
